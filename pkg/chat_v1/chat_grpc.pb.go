...
type ChatV1Client interface {
	...
	ConnectChat(ctx context.Context, in *ConnectChatIn, opts ...grpc.CallOption) (ChatV1_ConnectChatClient, error)
}
...
func (c *chatV1Client) ConnectChat(ctx context.Context, in *ConnectChatIn, opts ...grpc.CallOption) (ChatV1_ConnectChatClient, error) {
	stream, err := c.cc.NewStream(ctx, &ChatV1_ServiceDesc.Streams[0], ChatV1_ConnectChat_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
type ChatV1Server interface {
	...
	ConnectChat(*ConnectChatIn, ChatV1_ConnectChatServer) error
...
func (UnimplementedChatV1Server) ConnectChat(*ConnectChatIn, ChatV1_ConnectChatServer) error {
